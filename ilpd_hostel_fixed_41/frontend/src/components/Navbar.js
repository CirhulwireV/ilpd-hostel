...
const styles = {
  nav: { background: "#1a1a2e", minHeight: "72px", display: "flex", alignItems: "center", position: "sticky", top: 0, zIndex: 100, boxShadow: "0 2px 12px rgba(0,0,0,0.15)" },
  inner: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: "24px", width: "100%" },
  brand: { color: "#b8860b", fontSize: "20px", fontWeight: "700", display: "flex", alignItems: "center", textDecoration: "none", whiteSpace: "nowrap", lineHeight: 1, gap: "10px", padding: "4px 0" },
  centerLinks: { display: "flex", alignItems: "center", gap: "16px", flex: 1, justifyContent: "center" },
  auth: { display: "flex", alignItems: "center", gap: "20px", whiteSpace: "nowrap" },
